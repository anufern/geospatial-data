...
file_ = "/Users/anushkafernando/code/geospatial-data/data/2015.tif"
...
with rasterio.open(file_) as src:
    ...
    src_band = src_band.astype('int32')
...
with fiona.open('output.shp', 'w', 'ESRI Shapefile', shp_schema) as shp:
